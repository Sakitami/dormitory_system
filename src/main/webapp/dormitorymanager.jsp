    ...
    <div class="row">
        <div class="col-sm-10">
                            ...
                            <button type="button" class="btn btn-default" data-toggle="modal"
                                    data-target="#addUserModal">
										<span style="margin-right: 5px" class="" aria-hidden="true">
											<i class="fa fa-user-plus">添加寝室信息</i>
											</span>
                            </button>
                        </div>
                    </form>
            ...
            <div class="table-responsive">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="myModalLabel">添加寝室信息</h4>
                                </div>
                ...
                <!-- update框示例（Modal） -->
                <form method="post" action="/dormitory/update" class="form-horizontal" style="margin-top: 0px"
                      role="form"
                      id="form_data" style="margin: 20px;">
...
<script>
    $('#updateUserModal').on('show.bs.modal', function (event) {
        ...
        modal.find('.modal-title').text('修改寝室信息')
    ...
    $('#delUserModal').on('show.bs.modal', function (event) {
        ...
        var id = button.data('id')
        var modal = $(this)
        modal.find('.modal-title').text('删除寝室信息')
