    ...
    <div class="row">
        <div class="col-sm-10">
                    ...
                    <form role="form" class="form-inline" action="/dormitoryAdmin/search" method="post">
                        ...
                        <div class="form-group " style="margin-left: 48px">
                            <button type="button" class="btn btn-default" data-toggle="modal"
							    ...
							    <span style="margin-right: 5px;padding-right: 5px" aria-hidden="true">
            ...
            <div class="table-responsive">
                ...
                <!-- 删除模态框示例（Modal） -->
                <form method="post" action="/dormitoryAdmin/delete" class="form-horizontal"
                      style="margin: 0 20px 20px 20px" role="form" id="form_data">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-9">
                                                ...
                                                <input type="hidden" class="form-control" id="tab" name="tab"
                                                       placeholder="" value="dor_admin"> <input type="hidden"
                                                                                                class="form-control"
                                                                                                id="id" name="id"
                                                                                                placeholder="">
                                            </div>
